...
$sql = "SELECT p1.* , p2.name AS mentor_name FROM `ask_student` p1 JOIN `ask_mentor` p2 ON p1.mentor_id = p2.id";
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?php echo $v['id']; ?>">
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a onclick="student_delete(<?php echo $v['id'] ?>)" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
