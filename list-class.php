...
$sql = "SELECT p1.* , p2.name AS teacher_name FROM `ask_class` p1 JOIN `ask_teacher` p2 ON p1.teacher_id = p2.id";
$class = $conn->fetchRows($sql);
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-type">教师名</th>
                                            <th class="table-type">课程描述</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?php echo $v['id']; ?>">
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a onclick="class_delete(<?php echo $v['id'] ?>)" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
